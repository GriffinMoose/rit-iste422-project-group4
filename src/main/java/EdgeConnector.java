...
public class EdgeConnector {
   ...
   public EdgeConnector(String inputString) {
      ...
      isEP1Table = false;
      isEP2Table = false;
		 logger.debug("endPoint1: " + endPoint1 + " ... endPoint2: " + endPoint2 + " ... endStyle1: " + endStyle1 + "... endStyle2: " + endStyle2);
   }
   ...
   public void setIsEP1Field(boolean value) {
      isEP1Field = value;
		 logger.debug("isEp1Field set to " + value);
   }
   
   public void setIsEP2Field(boolean value) {
      isEP2Field = value;
		 logger.debug("isEp2Field set to " + value);
   }

   public void setIsEP1Table(boolean value) {
      isEP1Table = value;
		 logger.debug("isEp3Field set to " + value);
   }

   public void setIsEP2Table(boolean value) {
      isEP2Table = value;
		 logger.debug("isEp4Field set to " + value);
   }
}
